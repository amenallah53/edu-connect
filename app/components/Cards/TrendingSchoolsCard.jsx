...
export default function TrendingSchoolsCard({schoolName,schoolImg,location,numberStudents,
    rating,trendingStatus}) {
    
    return (
        <div className='hover:border-1 hover:border-[var(--color-border)] flex flex-col rounded-lg transition-all 0.5s ease-in group
            hover:shadow-md hover:border-[var(--color-muted)] hover:cursor-pointer hover:scale-[1.02]'>
            <div 
                className='bg-[var(--color-border)] bg-cover bg-center h-[125px] rounded-t-lg p-4 flex items-start justify-between'
